...
public class WorldRenderer {
	...
	/**
	 * Store ChunkMeshBatchAggregator by BlockFace, RenderMaterial and
	 * ChunkMeshBatchAggregator position
	 */
	...
	/**
	 * Gets the batch aggregator corresponding wuth the given mesh and
	 * material.
	 *
	 * @param mesh
	 * @param material

...
/**
 * A PlayerMetadataStore stores metadata for {@link org.spout.api.player.old.entity.entity.Player}
...
public class PlayerMetadataStore extends MetadataStoreBase<Player> implements MetadataStore<Player> {
	/**
	 * Generates a unique metadata key for {@link org.spout.api.player.old.entity.entity.Player} and

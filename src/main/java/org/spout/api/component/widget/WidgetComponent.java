...
/**
 * Represents a component which shapes the rendering and logic behind a {@link Widget}.
 */
public abstract class WidgetComponent extends Component implements SignalInterface, SubscriberInterface, Focusable, RenderPartContainer {
	...
	public final boolean attachTo(ComponentOwner owner) {
		if (!(owner instanceof Widget)) {
			throw new IllegalStateException("WidgetComponents are only allowed to be attached to Widgets.");
		}

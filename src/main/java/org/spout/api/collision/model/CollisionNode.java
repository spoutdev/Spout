...
public class CollisionNode {
	...
	public void addChild(String name, CollisionVolume volume) {
		if (children.containsKey(name)) {
			throw new IllegalArgumentException("This node already has that child");
		}
		//TODO add a check to see if this volume contains the other volume
		if (!this.volume.contains(volume)) {
			throw new IllegalArgumentException("Our Volume doesn't fully contain the Child Volume");
		}

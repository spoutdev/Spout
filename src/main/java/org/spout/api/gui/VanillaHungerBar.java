...
public class VanillaHungerBar extends AbstractWidget {
	 ...
	 * @return this
	 */
	public VanillaHungerBar setNumOfIcons(int icons) {
		this.icons = icons;
		return this;
	}
	 ...
	 * @return this
	 */
	public VanillaHungerBar setIconOffset(int iconOffset) {

...
public class BlockCause extends BaseCause<Block> implements Cause<Block> {
	...
	/**
	 * Creates a BlockCause with a parent. If the {@link #chainPosition} is larger than {@link org.spout.api.Engine#getCauseChainMaximum()}
	 ...
	 */
	public BlockCause(Block block, Cause parent) {
		super(parent);
		this.block = block;
	}

...
public class PlayerCause extends EntityCause {
	 ...
	 */
	public PlayerCause(Player player, Cause parent) {
		super(player, parent);
	}
	...
	protected void throwException() {
		throw new MaxCauseChainReached(getSource().getTransform().getPosition());
	}
}

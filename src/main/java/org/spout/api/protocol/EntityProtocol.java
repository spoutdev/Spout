...
public interface EntityProtocol {
	...
	/**
	 * Gets a message to spawn the entity.  The entity should spawn at the location at the last snapshot
	 * 
	...
	/**
	 * Gets a message to update the entity.  This should move the entity from its snapshot position to its live position.
	 * 
	 * @param entity the entity

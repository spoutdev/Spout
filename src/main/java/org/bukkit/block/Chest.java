...
public interface Chest extends BlockState, ContainerBlock {
	...
	/**
	 * Gets the other side of the larger double chest, if a double chest, or
	 * null if it is a single chest
	 *
	 * @return other chest
	 */
	...
	/**
	 * Gets the full double inventory of the double chest, or null if a single
	 * chest
	 *
	...
	/**
	 * Gets the largest possible inventory associated with this block If this
	 * block is part of a double chest, it will return the double inventory

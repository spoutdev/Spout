...
import org.getspout.unchecked.api.material.block.Air;
import org.getspout.unchecked.api.material.block.DoubleSlabs;
import org.getspout.unchecked.api.material.block.GenericLiquid;
import org.getspout.unchecked.api.material.block.Grass;
import org.getspout.unchecked.api.material.block.LongGrass;
import org.getspout.unchecked.api.material.block.Sapling;
import org.getspout.unchecked.api.material.block.Slab;
import org.getspout.unchecked.api.material.block.Solid;
import org.getspout.unchecked.api.material.block.StoneBricks;
import org.getspout.unchecked.api.material.block.Tree;
import org.getspout.unchecked.api.material.block.Wool;
import org.getspout.unchecked.api.material.item.Coal;
import org.getspout.unchecked.api.material.item.Dye;
import org.getspout.unchecked.api.material.item.GenericArmor;
import org.getspout.unchecked.api.material.item.GenericFood;
import org.getspout.unchecked.api.material.item.GenericItemMaterial;
import org.getspout.unchecked.api.material.item.GenericTool;
import org.getspout.unchecked.api.material.item.GenericWeapon;
...
public class MaterialData {
	 ...
	 *
	 * Creation occurs when a material exists at the given id, and zero data
	 * value, but does not have any subtypes. A new material that is a copy of
	 * the material at the given id and zero data value is created. If creation
	 * fails for any reason, null will be returned. If the material has subtypes
	 * normally, null will be returned if there is no subtype at the given data
	 * value
	 *
	 * @param id to get
	 * @param data to get
	...
	/**
	 * Returns a list of all the current materials in the game, notchian,
	 * custom, or otherwise
	 *
	...
	public static List<Material> getMaterials() {
		...
		for (Object element : idLookup) {
			if (element instanceof Material) {
				materials.add((Material) element);
			} else if (element instanceof Material[]) {
				for (Material mat : (Material[]) element) {
					if (mat != null) {
						materials.add(mat);
					}
				}

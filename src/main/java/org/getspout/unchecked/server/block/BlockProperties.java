...
import org.getspout.unchecked.server.block.physics.BlockPhysicsHandler;
import org.getspout.unchecked.server.block.physics.DefaultBlockPhysics;
import org.getspout.unchecked.server.block.physics.DoubleStepPhysics;
import org.getspout.unchecked.server.block.physics.FluidPhysics;
import org.getspout.unchecked.server.block.physics.SpecialPlaceBelowPhysics;
import org.getspout.unchecked.server.block.physics.ToggleableAttachablePhysics;
...
public enum BlockProperties {
	...
	MOB_SPAWNER(BlockID.MOB_SPAWNER, entity(SpoutCreatureSpawner.class)),
	...
	SIGN_POST(BlockID.SIGN_POST, passthru(), entity(SpoutSign.class), drops(ItemID.SIGN)),
	...
	WALL_SIGN(BlockID.WALL_SIGN, passthru(), entity(SpoutSign.class), drops(ItemID.SIGN)),
	...
	private Class<? extends SpoutBlockState> entity;
	...
	public Class<? extends SpoutBlockState> getEntityClass() {
		return entity;
	}

...
public class Transformm extends Transform {

	public Transformm(Point position, Vector3 direction, Vector3 scale) {
		super(position, direction, scale);
	}

	public Transformm(World world, double px, double py, double pz, double dx, double dy, double dz, double sx, double sy, double sz) {

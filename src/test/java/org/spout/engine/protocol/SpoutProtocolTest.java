...
public class SpoutProtocolTest extends BaseProtocolTest {
	...
	private static final Message[] TEST_MESSAGES = new Message[]{
		...
		new EntityTransformMessage(0, 
			TEST_TRANSFORM.getPosition().getWorld().getUID(), 
			new Vector3(TEST_TRANSFORM.getPosition().getX(), TEST_TRANSFORM.getPosition().getY(),
			TEST_TRANSFORM.getPosition().getZ()),
			TEST_TRANSFORM.getRotation(), TEST_TRANSFORM.getScale(), new NullRepositionManager()),

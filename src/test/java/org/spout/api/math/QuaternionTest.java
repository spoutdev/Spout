...
public class QuaternionTest {
	...
	public void testQuaternionDoubleDoubleDoubleDouble() {
		Quaternion q = Quaternion.create(1,0,0,0);
		testValues(q, 1, 0,0,0);
		q = Quaternion.create(4,2,6,8);
		testValues(q, 4,2,6,8);
	}

	@Test
	public void testQuaternionDoubleVector3() {
		Quaternion rot = Quaternion.create(0, new Vector3(1,0,0));
		...
		rot = Quaternion.create(40, new Vector3(3,2,1));
		...
		rot = Quaternion.create(120, new Vector3(6,-3,2));
	...
	public void testMultiplyQuaternionQuaternion() {
		Quaternion a = Quaternion.create(1,0,0,0);
		Quaternion b = Quaternion.create(1,0,0,0);
		Quaternion res = a.multiply(b);
		testValues(res, 0, 0, 0, -1);

		a = Quaternion.create(0,0,0,1);
		b = Quaternion.create(0,0,0,1);
		res = a.multiply(b);
		testValues(res, 0, 0, 0, 1);

		a = Quaternion.create(5,3,1,1);
		b = Quaternion.create(0,0,0,1);
		res = a.multiply(b);
		testValues(res, 5, 3, 1, 1);

		a = Quaternion.create(5,3,1,1);
		b = Quaternion.create(-5,2,1,0);
		res = a.multiply(b);
	...
	public void testGetAxisAngles(){
		...
		Vector3 res;
		float ang = 20;
		r = Quaternion.create(ang, new Vector3(1,0,0));
		res = r.getAxisAngles();
		if(res.getX() - ang >= eps) fail("Expected angle" + ang +", got " + res.getX());

		ang = 40;
		r = Quaternion.create(ang, new Vector3(0,1,0));
		res = r.getAxisAngles();
		if(Math.abs(res.getY() - ang) >= eps) fail("Expected angle" + ang +", got " + res.getY());

		ang = 140;
		r = Quaternion.create(ang, new Vector3(0,0,1));
		res = r.getAxisAngles();

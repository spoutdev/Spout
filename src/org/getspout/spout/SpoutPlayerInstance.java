...
class SpoutPlayerInstance { // Spout
	...
	final SpoutPlayerManager playerManager; // Spout

	@SuppressWarnings("rawtypes")
	public SpoutPlayerInstance(SpoutPlayerManager playermanager, int i, int j) { // Spout
	...
	public void b(EntityPlayer entityplayer) {
		if (this.b.contains(entityplayer)) {
			...
			if (this.b.size() == 0) {
				...
				SpoutPlayerManager.a(this.playerManager).b(i); // Spout
				if (this.dirtyCount > 0) {
					SpoutPlayerManager.b(this.playerManager).remove(this); // Spout
				}
	...
	public void a(int i, int j, int k) {
		if (this.dirtyCount == 0) {
			SpoutPlayerManager.b(this.playerManager).add(this); // Spout
			this.h = this.i = i;
			this.j = this.k = j;
			this.l = this.m = k;
		}

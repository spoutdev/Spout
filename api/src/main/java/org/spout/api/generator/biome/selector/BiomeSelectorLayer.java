...
public interface BiomeSelectorLayer extends LayeredBiomeSelectorElement {
	/**
	 * Picks and returns a {@link LayeredBiomeSelectorElement} from the seed and coordinates.
	 *
	 * @param x The x coordinate.
	 * @param y The y coordinate.
	 * @param z The z coordinate.
	 * @param seed The seed from which should be used to determine what element to pick.

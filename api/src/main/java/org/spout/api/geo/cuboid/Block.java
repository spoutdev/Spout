...
public interface Block extends WorldSource, ComponentOwner {
	...
	/**
	 * Translates this block above or below to the surface<br> The returned Block is the surface, <b>not</b> the first air block above.
	 *
	 * @return a new Block instance
	 */
	...
	/**
	 * Gets the biome type for this block, if the world generator used uses biomes.
	 *
	...
	/**
	 * Gets if this block is above or at the surface<br> This is the case if the block comes into contact with the sky
	 *
	...
	/**
	 * Resets all dynamic material updates queued for this block. This list is checked during the DYNAMIC_BLOCKS part of the tick, and will cause the onFirstUpdate method to be called.<br>
	 */
	@DelayedWrite
	public void resetDynamic();

	/**
	 * Immediately clears all dynamic material updates for this block.  This does not trigger the onPlacement() call.<br> Note: This method may only be called during dynamic updates and physics
	 */
	public void syncResetDynamic();

	/**
	 * Queues a dynamic update on this block<br> The Block Material must be dynamic for this to function.<br> Note: This method may only be called during dynamic updates and physics
	 *

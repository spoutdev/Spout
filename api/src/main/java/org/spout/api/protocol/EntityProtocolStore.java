...
/**
 * A store for storing EntityProtocols with fast array based lookup. Each entity entity type will have a protocol store which contains methods for creating the relevant network messages.
 */

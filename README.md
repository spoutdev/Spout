...
Who is SpoutDev?
----------------
SpoutDev is the team behind Spout, SpoutAPI, Spoutcraft, SpoutcraftAPI, SpoutCommons, and Spoutcraft Launcher.  
...
Compiling
---------
SpoutCommons uses Maven to handle its dependencies.
